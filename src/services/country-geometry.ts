...
/** Optional higher-resolution boundary overrides sourced from Natural Earth. Vendored locally
 * (public/country-boundary-overrides.geojson) rather than fetched from upstream's own CDN, so
 * this self-hosted instance never calls out to worldmonitor.app at runtime. */
